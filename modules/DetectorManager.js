...
class DetectorManager {
  ...
  async init() {
    if (this.initialized && this.isCacheValid()) {
      console.log('DetectorManager using cached detectors');
      return;
    }
    ...
    try {
      ...
      console.log(`DetectorManager initialized and cached ${this.detectors.size} detectors`);
    } catch (error) {
  ...
  async loadEnabledDetectors() {
    ...
    if (this.isCacheValid()) {
      ...
      console.log(`Using cached detectors: ${this.detectors.size} detectors loaded from cache`);
      return;
    }
  ...
  async loadDetector(id, config) {
    try {
      ...
      console.log(`Loaded detector: ${id}`);
    } catch (error) {
  ...
  async loadLegacyDetectors() {
    try {
      ...
      console.log('Loaded legacy detectors');
    } catch (error) {
